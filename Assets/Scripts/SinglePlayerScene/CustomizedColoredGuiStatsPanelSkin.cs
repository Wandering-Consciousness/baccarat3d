...
public class CustomizedColoredGuiStatsPanelSkin : MonoBehaviour
{
    ...
    public static GUISkin Skin {
        get { if (Instance != null)
                return Instance.actualSkin;
            return null;}
    }
 
    public static CustomizedColoredGuiStatsPanelSkin Instance {
        get;
        private set;
    }
    ...
    public void UpdateGuiColors (Color color, Color secondaryColor)
    {
        ...
        actualSkin.button.fontSize = GUIControls.fontScaler / actualSkin.button.fontSize;
...
//        actualSkin.horizontalSliderThumb.hover.background = UpdateGuiSkin (customSkin.horizontalSliderThumb.hover.background, secondaryColor);
        ...
        //actualSkin.label.normal.background = UpdateGuiSkin (customSkin.button.normal.background, color);
        actualSkin.label.normal.textColor = secondaryColor;
        actualSkin.label.hover.textColor = secondaryColor;
        actualSkin.label.active.textColor = secondaryColor;
        actualSkin.label.fontSize = GUIControls.fontScaler / actualSkin.label.fontSize;
...
//        actualSkin.customStyles [1] = new GUIStyle ("left-dragon");
//        actualSkin.customStyles [1].normal.background = UpdateGuiSkin (customSkin.FindStyle ("left-dragon").normal.background, secondaryColor);
//        actualSkin.customStyles [2] = new GUIStyle ("right-dragon");
//        actualSkin.customStyles [2].normal.background = UpdateGuiSkin (customSkin.FindStyle ("right-dragon").normal.background, secondaryColor);

//        // Title bar with no frame
//        actualSkin.customStyles [3] = new GUIStyle ("titlebar-noframe");
//        actualSkin.customStyles [3].normal.background = UpdateGuiSkin (customSkin.FindStyle ("titlebar-noframe").normal.background, color);
//
//        // Title bar with frame
//        actualSkin.customStyles [4] = new GUIStyle ("titlebar-withframe");
//        actualSkin.customStyles [4].normal.background = UpdateGuiSkin (customSkin.FindStyle ("titlebar-withframe").normal.background, color);
