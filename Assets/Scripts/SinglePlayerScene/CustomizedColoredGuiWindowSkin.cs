...
public class CustomizedColoredGuiWindowSkin : MonoBehaviour
{
    ...
    public static CustomizedColoredGuiWindowSkin Instance {
        get;
        private set;
    }
 
    public GUISkin actualSkin;
    ...
    public void UpdateGuiColors (Color color, Color secondaryColor)
    {
        ...
        actualSkin.window.fontSize = GUIControls.fontScaler / actualSkin.window.fontSize;
