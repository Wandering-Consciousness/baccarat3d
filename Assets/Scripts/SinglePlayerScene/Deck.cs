...
// This class represents one standard deck of cards
public class Deck : CardDeck
{
    ...
    public override void Initialize ()
    {
        ...
        for (int i=0; i<4; ++i) {
            ...
            // Debug: All face cards
//            string prefix = "S-";//prefixes [i];
//            CardDef jj = new CardDef (Atlas, Stock, "K", symbol, 0);
//            jj.Image = prefix + "King";
//            defs.Add (jj);
//            defs.Add (jj);
//            defs.Add (jj);
//            defs.Add (jj);
...
//            defs.Add (jj);
            ...
            // Debug: All xx cards
//            int xx = 7;
//            defs.Add (new CardDef (Atlas, Stock, ""+xx, symbol, xx));
//            defs.Add (new CardDef (Atlas, Stock, ""+xx, symbol, xx));
//            defs.Add (new CardDef (Atlas, Stock, ""+xx, symbol, xx));
//            defs.Add (new CardDef (Atlas, Stock, ""+xx, symbol, xx));
//            defs.Add (new CardDef (Atlas, Stock, ""+xx, symbol, xx));
